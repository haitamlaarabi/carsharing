...
import org.matsim.haitam.api.events.AbstractCarsharingEvent.TripLog;
...
public class CarsharingDropoffVehicleEvent extends AbstractCarsharingEvent {
	...
	public CarsharingDropoffVehicleEvent(double time, Scenario scenario, 
			CarsharingManager manager, 
			CarsharingAgent agent, 
			CarsharingStationMobsim station, 
			Collection<CarsharingVehicleMobsim> roadtrain,
